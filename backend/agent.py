...
with open('backend/secrets/ai_auth_url.txt', 'r') as file:
    ai_auth_url_txt = file.read()
with open('backend/secrets/ai_base_url.txt', 'r') as file:
    ai_base_url_txt = file.read()
with open('backend/secrets/ai_client_id.txt', 'r') as file:
    ai_client_id_txt = file.read()
with open('backend/secrets/ai_client_secret.txt', 'r') as file:
    ai_client_secret_txt = file.read()
with open('backend/secrets/ai_resource_group.txt', 'r') as file:
...
os.environ['AICORE_CLIENT_SECRET'] = ai_client_secret_txt
...
# read text
with open("backend/tc-summary.txt", 'r', encoding='utf-8') as file:
    text = file.read()
